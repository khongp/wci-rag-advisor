...
def get_rag_chain():
    ...
    system_prompt = (
        ...
        "7. At the end of your response, append a 'Recommended WCI Hubs' section. "
        "Select 1-2 relevant hubs from the dictionary below and format them as markdown links: "
        "'- [Hub Name](URL)' (do not output the raw URL text, use the exact name as the anchor text).\n"
